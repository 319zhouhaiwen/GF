...
public GoodsService getGoodsService() {
	GoodsService goodsService = (GoodsService) this.getRequestContext().getWebApplicationContext().getBean("goodsService");
	return goodsService;
}
	...
	protected int doStartTagInternal() throws Exception {
		...
		List<GoodsEntity> listGoods = getGoodsService().Query();
