...
import mapper.login.Floginmapper;
...
//	private JdbcTemplate jdbcTemplate;
	@Autowired
	private Floginmapper floginmapper;
...
//		return mark;
		...
		try {
			mark=floginmapper.fcheckUser(map);
		} catch (DataAccessException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		return mark;
		...
		int mark=0;
		try {
			mark=floginmapper.ajaxcha(useraccount);
		} catch (DataAccessException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
