		...
		success:function(obj){
			...
			for(var i=0;i<obj.list.length;i++){
				...
				$("#trialquery").append(
						...
						"<td>"+
							"<a href='<%=request.getContextPath()%>/goodsreciewHandler/goodsTrial?id="+obj.list[i].id+"'><button class='btn btn-success btn-xs' data-toggle='modal' id='tg'><fmt:message key="adopt"></fmt:message></button></a>"+
							"<a href='' name='deleteid' id='"+obj.list[i].id+"'><button class='btn btn-danger btn-xs' data-toggle='modal'><fmt:message key="noPass"></fmt:message></button></a>"+ 
						"</td>"+
					"</tr>"
				);
			}
