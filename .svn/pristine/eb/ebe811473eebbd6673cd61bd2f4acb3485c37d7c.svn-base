...
import mapper.agent.AgentMapper;
...
public class AgentDao {
	...
	public String agentcode(String name) {
		String code = agentMapper.agentcode(name);
		return code;
	}
//	public String agentcode(String name) {
...
//	}
	...
	public List<Agent> select(String str,PageEntity pageEntity){
		...
		List<Agent> list = agentMapper.select(map);
		return list;
	}
//	public List<Agent> select(String str,PageEntity pageEntity) {
...
//	}
	...
	public List<Agent> agentquery(){
		List<Agent> list = agentMapper.agentquery();
		return list;
	}
//	public List<Agent> agentquery() {
...
//	}
	...
	public String selectcode(String name) {
		String code = agentMapper.selectcode(name);
		return code;
	}
//	public String selectcode(String name) {
...
//	}
	...
	public int agentCount(String name) {
		int count = agentMapper.agentCount(name);
		return count;
	}
//	public int agentCount(String name) {
...
//	}
	...
	public Agent get(int id) {
		Agent agent = agentMapper.get(id);
		return agent;
	}
//	public Agent get(int id) {
...
//	}
	...
	public int count(String name) {
		int count = agentMapper.count(name);
		return count;
	}
//	public int count(String name) {
...
//	}
	...
	public List<Agent> Query(String name){
		List<Agent> list = agentMapper.Query(name);
		return list;
	}
//	public List<Agent> Query(String name) {
