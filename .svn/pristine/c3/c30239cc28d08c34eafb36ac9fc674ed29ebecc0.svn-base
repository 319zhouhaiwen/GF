...
public class BrandDao {
	...
	public List<Brand> select(String str,PageEntity pageEntity){
		...
		List<Brand> list = brandMapper.select(map);
		return list;
	}
//	public List<Brand> select(String str,PageEntity pageEntity) {
...
//	}
	...
	public int brandCount(String name) {
		int count = brandMapper.brandCount(name);
		return count;
	}
//	public int brandCount(String name) {
...
//	}
	...
	public String selectcode(String name) {
		String code = brandMapper.selectcode(name);
		return code;
	}
//	public String selectcode(String name) {
...
//	}
	...
	public int count(String name) {
		int count = brandMapper.count(name);
		return count;
	}
//	public int count(String name) {
...
//	}
	...
	public List<Brand> query(){
		List<Brand> list = brandMapper.query();
		return list;
	}
//	public List<Brand> query() {
